        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="{{route('home')}}" class="btn btn-success"> <span>Trở về</span></a>
                        <a href="{{route('hoadon.create')}}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Thêm hóa đơn</span></a>
